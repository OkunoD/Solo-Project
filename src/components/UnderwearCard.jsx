...
const mapStateToProps = function(state, ownProps) {
  return {
    id: state.underwearList[ownProps.index].id,
    name: state.underwearList[ownProps.index].name,
    color: state.underwearList[ownProps.index].color,
    size: state.underwearList[ownProps.index].size,
    brand: state.underwearList[ownProps.index].brand,
    file: state.underwearList[ownProps.index].file,
    type: state.underwearList[ownProps.index].type,
    ...
    <div className="itemBox">
      ...
      <div className="item-button-div">
        <input className="black-button" onClick={() => {
          ...
          props.tryOnItem('underwear', props.id, "underwear")}} type="Submit" value="Try it on" readOnly/>
...
export default connect(mapStateToProps, mapDispatchToProps) (Underwear);
