...
export const ItemEditorModal = ({ 
  ...
  const [newSubtype, setNewSubtype] = useState(currentSubtype);
    ...
    <div className="edit-item-modal">
      <div className="edit-item-borders">
        <div className="top-edit-div">
          ...
          <div>
            <input className="edit-subtype-field" placeholder={(currentSubtype=="") ? "subtype" : currentSubtype} onChange={(e) => setNewSubtype(e.target.value)} type="text" value={newSubtype} />
          </div>
        ...
        <button className="update-item-button" onClick={() => {
          ...
          console.log("newSubtype is", newSubtype);
